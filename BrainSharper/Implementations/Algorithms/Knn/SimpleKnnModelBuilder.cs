...
namespace BrainSharper.Implementations.Algorithms.Knn
{
    ...
    {
        public virtual IPredictionModel BuildModel(IDataFrame dataFrame, string dependentFeatureName,
            IModelBuilderParams additionalParams)
        {
            ...
            return new KnnPredictionModel<TPredictionResult>(preparedData.Item1, preparedData.Item2, preparedData.Item3,
                knnParams.KNeighbors, knnParams.UseWeightedDistances);
        }

        public virtual IPredictionModel BuildModel(IDataFrame dataFrame, int dependentFeatureIndex,
            IModelBuilderParams additionalParams)
        {
            ...
            string dependentFeatureName)
        {
            ...
            var expectedOutcomes = dataFrame.GetColumnVector<TPredictionResult>(dependentFeatureName);
            return new Tuple<Matrix<double>, IList<TPredictionResult>, IList<string>>(trainingData, expectedOutcomes,
                dataColumns);
        }
    }
}